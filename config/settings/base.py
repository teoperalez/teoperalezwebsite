...
)  # (teo_peralez_website/config/settings/base.py - 3 = teo_peralez_website/)
APPS_DIR = ROOT_DIR.path("teo_peralez_website")
...
LOCAL_APPS = [
    "teo_peralez_website.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "teo_peralez_website.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "teo_peralez_website.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Teo Peralez""", "teoperalez@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "teo_peralez_website.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "teo_peralez_website.users.adapters.SocialAccountAdapter"
...
GRAPHENE = {
    "SCHEMA": "teo_peralez_website.graphql.schema.schema",
